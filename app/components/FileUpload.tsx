  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-[80vh] gap-8 px-4">
      ...
      <div className="text-xs text-gray-400 max-w-md text-center border-t border-gray-200 pt-4">
        <p>Your data stays on your device. Nothing is sent to a server or stored in the cloud &mdash; all processing happens entirely in your browser.</p>
        <p className="mt-3">Created by <a href="https://chofter.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 underline">Shane O&apos;Sullivan</a></p>
      </div>
    </div>
  );
}
